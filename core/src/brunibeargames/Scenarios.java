...
public class Scenarios {
    ...
    static  int[][] corp1s0Allies =   {{144,15,15},{147,15,15},{151,15,14},{148,14,14},{145,14,16},
                ...
                {134,2,18},{135,1,17},{150,16,14},{149,16,14},{136,0,18},
                {138,0,18},{137,0,18},{140,0,18},{141,0,18},{142,0,18},{143,0,18}};
    static  int[][] corp1Cs0Allies  ={{223,12,17},{221,12,15},{220,12,15},
                         {219,12,15},{218,12,15},{225,11,20},{224,12,17},{222,11,15}};

    static int[][] corp5s0Allies = {{208,14,25},{197,14,25},{198,14,25},{199,12,26},
        {206,4,29},{203,8,27},{204,6,28},{205,5,28},{207,11,27},{209,3,28}};

    static int[][] corp2Cs0Allies = {{230,10,18},{229,10,18},{231,10,18}};

    static int[][]corp3Cs01Allies = {{236,0,10},{232,0,10},{238,0,18},{234,0,18}
                                    ,{167,7,16},{168,7,16},{160,7,16},{161,7,16}};
    ...
    static int[][] corp7s01Russian = {{71,23,13},{77,24,13},{75,24,13},{74,24,13},
                        {76,21,12},{73,16,21},{72,20,16}};

    static int[][] corp8s01Russian = {{78,22,16},{80,23,17},{79,22,16},{83,22,15},
            {81,19,15},{88,20,17},{85,20,17},{84,20,17},{86,17,22}};

    static int[][] corp4Cs01Russian = {{89,21,16},{90,21,22},{91,19,17},
